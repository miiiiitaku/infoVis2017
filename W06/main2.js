function main(){
    ...
    geometry.faces[3].color = new THREE.Color(0,1,1);
    geometry.faces[4].color = new THREE.Color(1,0.5,0.5);
    ...
    geometry.faces[8].color = new THREE.Color(0.5,0,1);
    geometry.faces[9].color = new THREE.Color(0.5,1,1);
    geometry.faces[10].color = new THREE.Color(0,1,0.5);
