function main()
{
    ...
    geometry.face[0].color = new THREE.Color(1,0,0);
    geometry.face[1].color = new THREE.Color(0,1,0);
    geometry.face[2].color = new THREE.Color(0,0,1);
    geometry.face[3].color = new THREE.Color(1,1,0);
    geometry.face[4].color = new THREE.Color(1,1,1);
    geometry.face[5].color = new THREE.Color(1,0,1);
    geometry.face[6].color = new THREE.Color(0,1,1);
    geometry.face[7].color = new THREE.Color(1,0,0);
    geometry.face[8].color = new THREE.Color(1,1,0);
    geometry.face[9].color = new THREE.Color(1,1,1);
    geometry.face[10].color = new THREE.Color(1,0,1);
